...
[NautilusTrader](http://nautilustrader.io) 的网络功能。

*network* 包提供网络组件，包括 HTTP、WebSocket 和原始 TCP 套接字客户端、速率限制、退避策略和套接字 TLS 实用程序，用于连接交易场所和数据提供商。
...
有关更详细的使用方法，请参阅[文档](https://docs.rs/nautilus-network)。
