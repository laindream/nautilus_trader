...
[NautilusTrader](http://nautilustrader.io) 的命令行界面和工具。

*cli* 包提供了一个全面的命令行界面，用于管理和操作 NautilusTrader 安装。它包括数据库管理、系统配置和操作实用程序等工具：
...
有关更详细的使用方法，请参阅[文档](https://docs.rs/nautilus-cli)。
