...
[NautilusTrader](http://nautilustrader.io) 的投资组合分析和性能指标。

*analysis* 包提供了一个全面的投资组合分析工具套件和性能统计，用于评估交易策略和投资组合。这包括基于收益的指标、基于盈亏的统计数据以及量化金融中常用的风险度量：
...
有关更详细的使用方法，请参阅[文档](https://docs.rs/nautilus-analysis)。
